...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <form action="{{ url('admin/time-in') }}" method="post">

          @csrf
        @else
        <form action="{{ url('admin/time-out').'/'.$last->id }}" method="post">
        ...
        @endif
              ...
              <div class="">
                @if(!empty($last->time_out) OR $last == NULL)
                  <button type="submit" class="btn  bg-gradient-primary swal-out" id="on">Time-In</button>
                  @else
                  <button type="submit" class="btn bg-gradient-secondary swal-in" id="off">Time-Out</button>
                  @endif
            </div>
            <hr>
