...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="col-sm-12">
              <h4 class="text-center text-dark">Admin Timesheet</h4>
            </div><!-- /.col -->
    </div>
    <!-- /.content-header -->
    <!-- Main content -->
        ...
        <div class="card card-primary card-outline">
             ...
             <div class="row">
              <div class="col-md-12 col-lg-4 col-sm-12 col-xs-12 mb-2">
                <form action="{{url('/admin/timesheet')}}" method="POST">
                  @csrf
...
@endif
              ...
              <div class="col-md-12 col-lg-4 col-sm-12 col-xs-12 mb-2">
                <button class="btn btn-primary btn-block btn-md" id="admin-excel">Convert to Ecxel</button>

              </div>
              <div class="col-md-12 col-lg-4 col-sm-12 col-xs-12 mb-2">
                <button class="btn btn-danger btn-block btn-md truncate_admin" type="button">Delete All</button>
              </div>
             </div>   
          <table class="table table-striped table-responsive-md exceladmin">
        <thead>
          <tr>
            <th>Name</th>
